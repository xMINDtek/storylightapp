...
<?php
require '/home/vol6_1/epizy.com/epiz_26786365/htdocs/res/scripts/sidebar.php'; ?>
...
<script type = "text/javascript">
	...
	<div class="container-section1">
		<div class="cont1_top">
			...
			<?php echo "<img id='img_tl' style='width: 100px; height: 100px' src='{$_SESSION["avitar"]}' type='img/png'>" ?>
				 <h3> DMs</h3>
				 <h3> Tags</h3>
				 <h3> Comments</h3>
				 <?php print "<h3> {$_SESSION['avitar']}</h3>" ?>
			</div> 

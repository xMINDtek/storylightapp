...
if (isset($_POST['signup-submit'])){
    ...
    $imageFileLocation = "/account/userimages/" . "$newImageNameClean";
    $imageFileLocationDb = "/account/userimages/" . "$newImageName";

    $defaultImageLocation = "/account/userimages/default.png";    
